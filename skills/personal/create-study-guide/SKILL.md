...
```bash
python3 ~/.agents/skills/personal/create-study-guide/scripts/clean_study_guide.py <CONTENT.md> <SUMMARY.md> [OUTPUT.md]
```
...
python3 ~/.agents/skills/personal/create-study-guide/scripts/clean_study_guide.py CONTENT.md SUMMARY.md
```
